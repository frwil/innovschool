...
class StudySubject
{
    ...
    #[ORM\OneToMany(mappedBy: 'subject', targetEntity: \App\Entity\ClassSubjectModule::class)]
    private Collection $classSubjectModules;
    ...
    public function addClassSubjectModule(\App\Entity\ClassSubjectModule $module): self
    {
        if (!$this->classSubjectModules->contains($module)) {
            $this->classSubjectModules[] = $module;
            $module->setSubject($this);
    ...
    public function removeClassSubjectModule(\App\Entity\ClassSubjectModule $module): self
    {
        if ($this->classSubjectModules->removeElement($module)) {
            if ($module->getSubject() === $this) {
                $module->setSubject(null);
