...
#[ORM\Entity(repositoryClass: SchoolClassNumberingTypeRepository::class)]
#[UniqueEntity(fields: ["sectionCategory", "school", "numberingType"])]
#[ORM\Table(
    name: "school_class_numbering_type",
    uniqueConstraints: [
        new ORM\UniqueConstraint(name: "unique_numbering_type", columns: ["section_category_id", "school_id", "numbering_type"])
    ]
)]
class SchoolClassNumberingType
{
