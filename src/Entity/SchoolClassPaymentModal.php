...
=======
<<<<<<<< HEAD:src/Entity/SchoolClassPaymentModals.php
========
<?php
...
#[ORM\Entity(repositoryClass: SchoolClassPaymentModalRepository::class)]
#[ORM\Table(
    name: "school_class_payment_modals",
    uniqueConstraints: [
        new ORM\UniqueConstraint(
            name: "unique_class_school_period",
            columns: ["school_class_period_id", "school_id", "school_period_id", "modal_type"]
        )
    ]
)]
class SchoolClassPaymentModal
...
>>>>>>>> claude/naughty-rubin-200ad9:src/Entity/SchoolClassPaymentModal.php
