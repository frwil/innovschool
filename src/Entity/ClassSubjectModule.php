...
#[ORM\Entity(repositoryClass: ClassSubjectModuleRepository::class)]
#[ORM\Table(name: 'class_subject_module')]
#[ORM\UniqueConstraint(columns: ['subject_id', 'class_id', 'period_id', 'school_id'])]
#[ORM\HasLifecycleCallbacks]
class ClassSubjectModule
{
    #[ORM\Id]
    ...
    #[ORM\ManyToOne(targetEntity: StudySubject::class, inversedBy: 'classSubjectModules', cascade: ['persist', 'remove'])]
    #[ORM\JoinColumn(nullable: false)]
    private ?StudySubject $subject = null;
    ...
    #[Assert\NotBlank]
    #[Assert\Positive]
    private ?int $moduleNotation = null;
    ...
    public function getModuleNotation(): ?int
    {
        return $this->moduleNotation;
    }

    public function setModuleNotation(?int $moduleNotation): self
    {
        $this->moduleNotation = $moduleNotation;
